# Quick instructions for AI coding agents working on ggsegHO
...
- `data/*.rda` — Unified `ggseg_atlas` objects (2D-only for this atlas)
- `R/data.R` — Roxygen2 documentation for each atlas
- `R/ggsegHO-package.R` — Package-level docs, imports ggseg.formats
...
class. The atlas objects work with `ggseg::geom_brain()` (2D).
